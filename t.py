...
sfont = pg.font.SysFont("inkfree",25)
minifont = pg.font.SysFont("Lucida Console",15)
...
music1 = mixer.music.load("Music.mp3")
mixer.music.play()
def tic_tac_toe():
    ...
    def users():
        ...
        p1_prompt = minifont.render("Enter player-1 name:",True,(10,10,10))
        p2_prompt = minifont.render("Enter player-2 name:",True,(10,10,10))
        ...
        Enter = font.render("START !",1,(75,0,130))
        
        while True:
            screen.fill((255,236,139))
            screen.blit(heading,((width-heading.get_width())/2,5))
            userNameSurface_1 = font.render(player1_name, True,(84,84,84))
            ...
            userNameSurface_2 = font.render(player2_name, True, (84,84,84))
            ...
            if p1_active:
                ...
                p1_prompt = font.render("Enter player-1 name:", True, (0,0,0))
            else:
                pg.draw.rect(screen, slategrey, userNameBorder_1, 2)
                p1_prompt = font.render("Enter player-1 name:", True, slategrey)
            if p2_active:
                pg.draw.rect(screen, white, userNameBorder_2, 2)
                p2_prompt = font.render("Enter player-2 name:", True, (0,0,0))
            else:
                pg.draw.rect(screen, slategrey, userNameBorder_2, 2)
                p2_prompt = font.render("Enter player-2 name:", True, slategrey)
            ...
            submitButton = create_button((width / 2) - (Enter.get_width() / 2) - 5, height ,Enter.get_width() + 10, Enter.get_height(),(240,230,140),(227,207,87))
    ...
    def draw_status():
        ...
        p1_name = minifont.render(player1_name+": X",1,(255,255,255))
        p2_name = minifont.render(player2_name+": O",1,(255,255,255))
